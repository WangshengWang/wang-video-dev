...
import com.wang.enums.VideoStatusEnum;
//import com.wang.enums.VideoStatusEnum;
...
import com.wang.utils.FetchVideoCover;
import com.wang.utils.IMoocJSONResult;
import com.wang.utils.MergeVideoMp3;
...
//		String fileSpace = "C:/imooc_videos_dev";
	 ...
	 * 查询我发布的视频
	 */
	@PostMapping(value="/showMyAll")
	public IMoocJSONResult showMyAll(String userId, Integer page, Integer pageSize) 
			throws Exception{
		if (page == null) {
			page = 1;
		}
		...
		PagedResult result = videoService.getMyAllVideos(userId, page, pageSize);
		return IMoocJSONResult.ok(result);
	}
